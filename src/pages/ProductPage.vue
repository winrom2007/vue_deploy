<template>
  ...
  <main class="content container" v-else-if="!productsData">Не удалось получить данный с сервера</main>
      ...
      <div class="item__info">
        ...
        <div class="item__form">
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row">
              <div class="form__counter">
                <button
                  ...
                  @click.prevent="numberCounterChange(-1)"
                >
            ...
            <div v-show="productAddSending">Длбавление товара в корзину...</div>
          </form>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    numberCounterChange(step) {
      this.productAmount = numberCounter(this.productAmount, step);
    },
    loadProduct() {
      ...
      .catch (()=>productLoadingFailed=true)
